...
return [
    ...
    */
    ...
    'custom' => [
        'hoten' => [
            ...
            'regex'=>'Thông tin định dạng không hợp lệ.'
        ],
        'diachi' => [
            'required' => 'Thông tin không được bỏ trống',
            'regex'=>'Thông tin định dạng không hợp lệ.'
        ...
        'phone' => [
            ...
            'not_in'=>'Nhập số điện thoại quý khách đang sử dụng'
        ],
        'fullname' => [
            'required' => ':attribute không được bỏ trống',
        ],
    ...
    */
    ...
    'attributes' => [
        'price_from' => 'khoảng giá đầu',
        'price_to' => 'khoảng giá cuối',
        'percent' => 'phần trăm điều chỉnh',
        'title' => 'tiêu đề',
        'h1'=>'thẻ H1',
        'content'=>'nội dung',
        'name'=>'tên',
        ...
        'general.site_description'=>'giới thiệu website',
        'general.post_limit'=>'số bài hiển thị trên trang',
        'general.sim_limit'=>'số sim hiển thị trên trang',
        'hotline.seller'=>'số điện thoại kinh doanh',
        'hotline.zalo'=>'link chat group zalo',
        'hotline.phone'=>'số hotline phản ánh',
        'sim_setting.uu_tien_gia_nho'=>'ưu tiên giá nhỏ hơn',
        'sim_setting.uu_tien_gia_lon'=>'ưu tiên giá lớn hơn',
        'hoten'=>'Số muốn BÁN hoặc CẦM CỐ',
        'diachi'=>'Giá mong muốn',
        'dienthoai'=>'Điện thoại liên hệ',
        'question.*' => 'Câu hỏi',
        'answer.*' => 'Câu trả lời',
        'phone' => 'Điện thoại',
        'address' => 'Địa chỉ',
