...
<head>
    ...
    <style amp-custom="">
        ...
        h1+.ampstart-byline span{
            font-style: normal;
        }
        h1+.ampstart-byline span,
        h1+.ampstart-byline time,
        h1+.ampstart-byline a{
            color: #888;
            font-size: 120%;
        }
        h2{
...
<body>
    @include('components.theme.amp.header')
    @include('components.theme.amp.sidebar')
    @yield('content')
    @include('components.theme.amp.footer')
</body>
</html>
