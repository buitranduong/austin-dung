        ...
        <form action="{{ route('admin.user.store') }}" method="POST" autocomplete="off">
            ...
            <div>
                ...
                <div class="mb-3">
                    ...
                    <input autocomplete="none" type="email" class="form-control" id="email" name="email" value="{{ old('email') }}"
                ...
                <div class="mb-3">
                    ...
                    <input autocomplete="none" type="password" class="form-control" id="password" name="password" value="{{ old('password') }}"
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" name="x" value="{{ old('x ')}}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" name="tiktok" value="{{ old('tiktok ')}}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="head_script_before" class="form-control" name="head_script_before">{!! old('head_script_before') !!}</textarea>
                </div>
                <div class="mb-3">
                    <label for="head_script_after" class="form-label fw-bold">{{ __('Scrip head after') }}</label>
                    <textarea id="head_script_after" class="form-control" name="head_script_after">{!! old('head_script_after') !!}</textarea>
                </div>
                <div class="mb-3">
                    <label for="body_script_before" class="form-label fw-bold">{{ __('Scrip body before') }}</label>
                    <textarea id="body_script_before" class="form-control" name="body_script_before">{!! old('body_script_before') !!}</textarea>
                </div>
                <div class="mb-3">
                    <label for="body_script_after" class="form-label fw-bold">{{ __('Scrip body after') }}</label>
                    <textarea id="body_script_after" class="form-control" name="body_script_after">{!! old('body_script_after') !!}</textarea>
                </div>
            </div>
        </form>
    </div>
