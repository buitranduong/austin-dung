    ...
    <div>
        <div class="d-flex">
            <div class="d-inline-flex gap-1 flex-grow-1 align-items-center">
                ...
                <div>
                    <a href="{{ route('admin.tag.trash') }}" class="btn btn-danger">
        ...
        <table class="table table-striped table-hover mt-3">
            <thead class="table-light">
                <tr>
                    <th scope="col" class="col-2">{{ __('Tên thẻ') }}</th>
                    <th scope="col" class="col-2">{{ __('Ảnh') }}</th>
                    <th scope="col" class="col-2">{{ __('Slug') }}</th>
                    <th scope="col" class="col-2">{{ __('Mô tả') }}</th>
            ...
            <tbody>
                @forelse($tags as $tag)
                    <x-admin.tag :tag="$tag"></x-admin.tag>
                @empty
                <tr>
                  <td class="text-center" colspan="7">{{ __('Không có bản ghi') }}</td>
                </tr>
            @endforelse
            </tbody>
            <caption>
