<nav class="navbar navbar-expand-lg bg-body-tertiary" style="grid-template-columns: 1fr 2fr;">
    <div class="container-fluid">
        <a href="#" class="navbar-brand">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16">
                <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
            </svg>
            <span>SimThangLong</span>
        </a>
        <div>
            @if(session('message'))
                <x-admin.alert dismissible>
            ...
            @endif
            @if($errors->any())
                <x-admin.alert color="danger" dismissible>
        ...
        <div class="d-flex align-items-center">
            <ul class="nav me-3">
                <li class="nav-item">
                    <a href="#" class="btn btn-light position-relative" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
            ...
            <div class="flex-shrink-0 dropdown">
                ...
                <ul class="dropdown-menu text-small shadow dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('admin.artisan.optimize.clear') }}">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('admin.artisan.opcache.compile') }}">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('admin.artisan.cache.clear') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-repeat" viewBox="0 0 16 16">
                                <path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.36a.25.25 0 0 1 .192-.41m-11 2h3.932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9"/>
                                <path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5 5 0 0 0 8 3M3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9z"/>
                            </svg>
                            Xóa bộ nhớ đệm redis
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{ route('admin.artisan.responsecache.clear') }}">
...
<div class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasScrollingLabel" style="top: 66px">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasRightLabel">{{ __('Thông báo') }}</h5>
