...
return new class extends SettingsMigration
{
    ...
    {
        $this->migrator->add('blog.title', 'Austin Dũng - Tin Sim Số Đẹp, Phong Thủy, Tử vi mới nhất');
        $this->migrator->add('blog.description', 'Austin Dũng - Blog chia sẻ tin tức sim số đẹp, sim data, gói cước, phong thủy sim, tử vi theo nhiều góc nhìn của chuyên gia');
