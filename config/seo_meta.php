...
return [
    'meta'=>[
        ...
        ['name'=>'ICBM', 'content'=>'21.024090555843472, 105.83262432804791'],
        ['name'=>'google-site-verification', 'content'=>'UFv8MH6-Np6Uer7oZ-Imj0YryonKagn8WCQ6Y4mGbug'],
    ],

    'link'=>[
        ['rel'=>'canonical', 'href'=>'https://simthanglong.vn'],
        ['rel'=>'manifest', 'href'=>'/manifest.json'],
        ['rel'=>'apple-touch-startup-image', 'href'=>'https://static.simthanglong.vn/favicon.ico'],
        ['rel'=>'apple-touch-icon', 'href'=>'https://static.simthanglong.vn/favicon.ico'],
        ['rel'=>'icon', 'href'=>'https://static.simthanglong.vn/favicon.ico', 'type' => 'image/x-icon'],
    ]
];
