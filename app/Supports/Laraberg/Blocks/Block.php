...
namespace App\Supports\Laraberg\Blocks;

use App\Supports\Laraberg\OEmbed\OEmbedService;
...
class Block
{
    ...
    /** @var \App\Supports\Laraberg\OEmbed\OEmbedService  */
    ...
    public function __construct(
        ...
        $this->registry = app(BlockTypeRegistry::class);
        $this->embedService = app(OEmbedService::class);
    }
